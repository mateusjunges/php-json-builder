...
class Json implements ArrayAccess, Arrayable, JsonSerializable, Jsonable, Stringable
{
     ...
     * @return $this
     */
    public function set($key, $value, $overwrite = true): Json
    {
     ...
     * @return $this
     */
    public function forget($key): Json
    {
        $segment = &$this->data;
     ...
     * Create a new Json instance.
     *
     * @param  string|iterable|null  $json
     * @return static
     */
    public static function make($json = null): Json
    {
        if (is_string($json)) {
